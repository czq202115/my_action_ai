...
# 启动 Docker 容器
sudo docker run  -itd --name chat -v $GITHUB_WORKSPACE/models/:/models/ -p 8000:8000 ghcr.io/ggerganov/llama.cpp:server -m /models/MiniCPM-2B-dpo-fp16-gguf.gguf --port 8000 --host 0.0.0.0 -n 1024
